package sura.pruebalegoback.infraestructure.entry-points.subs-events;
...
public class RabbitMQReceiverConfig {
    ...
    Mono<Connection> connectionMono() {
        ...
        return Mono.fromCallable(connectionFactory::newConnection)
                ...
                .retryWhen(Retry.backoff(Long.MAX_VALUE, Duration.ofSeconds(5))
                        ...
                        .doBackoff((retrySignal -> log.warn("Reintentando conexión a RabbitMQ para receiver. Intento: {}, Error: {}",
    ...
    ChannelPool channelPool(Mono<Connection> connectionMono) {
        ...
        poolOptions.setMaxCacheSize(10); // Max 10 channels in pool for receiver
        return ChannelPoolFactory.create(connectionMono, poolOptions);
    }

    @Bean
    Receiver receiver(Mono<Connection> connectionMono, ChannelPool channelPool) {
