package sura.pruebalegoback.infraestructure.driven-adapters.r2dbc;
...
public class PatientRepositoryAdapter implements PatientRepository {
    ...
    private static final Logger log = LoggerFactory.getLogger(PatientRepositoryAdapter.class);
